...
return (
    ...
    {media.map((media) => {
          return (<>
            <div>
              <img className="avatar_pic"src={`https://tgyucrjdklladsjukszn.supabase.co/storage/v1/object/public/pets/${media.id}`} />
            </div>
          </>
          )
        })}
                    ...
                    <Link  to={'/history'}>
                        <button type="submit" className={PetCardCSS.button}>history</button>
                    </Link>
