...
function Home() {
  ...
  return (
    <>
      ...
      <div className="h1">
        <h1>Pet MD</h1>
        <p>A place to track your pets medical information and history</p>
      </div>
      ...
      <div className="info-box">
        <div className="inner-info1">
          ...
          <div className="card-3"><img className="img-3" src="https://res.cloudinary.com/embark/images/f_auto,q_auto/v1659364976/embarkvet.com/uploads/brown-puppy-with-veterinarian/brown-puppy-with-veterinarian.jpg?_i=AA"/></div>
